...
Vvveb.Gui = {
	...
	checkSiteStatus: async function(siteId, netlifyToken) {
		...
		console.log("netlifyToken: ", netlifyToken);
		let response = await fetch("https://api.netlify.com/api/v1/sites/" + siteId, requestOptions);
	...
	waitForSiteCreation: async function(siteId, netlifyToken) {
		...
		while (!siteReady) {
			...
			siteReady = await Vvveb.Gui.checkSiteStatus(siteId, netlifyToken);
			console.log('Site not ready yet');
		}
	},
	...
	deployToNetlify: async function() {
		...
		if (!siteId) {
			try {
				...
				let createSiteResponse = await fetch("https://api.netlify.com/api/v1/sites", siteRequestOptions);
		...
		// Define your requestOptions
		let deployRequestOptions = {
			method: 'POST',
			headers: myHeaders,
			body: zipBuffer,
			redirect: 'follow',
	...
	toggleEditor : function () {
		console.log("HI FROM TOGGLE EDITOR");
	...
	toggleEditorJsExecute : function () {
		console.log("HI FROM TOGGLE EDITOR JS EXECUTE");
	...
	fullscreen : function () {
		console.log("HI FROM FULLSCREEN");
	...
	clearSearch : function (e) {
		console.log("HI FROM CLEAR SEARCH");
	...
	setDesignerMode : function () {
		console.log("HI FROM SET DESIGNER MODE");
